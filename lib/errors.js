...
errors.getProtocolError = function(code, msg) {
    ...
    switch(code) {
        ...
        case 'ERR_BAD_TYPE':      return new errors.ApiError('Invalid user type for this operation');
        case 'ERR_NOT_FOUND':     return new errors.ApiError('Record is not found');
        case 'ERR_ALREADY_EXISTS':return new errors.ApiError('Record already exists');
        case 'ERR_INV_EXPIRED':   return new errors.ApiError('This invoice is expired');
        case 'ERR_INV_REQUESTED': return new errors.ApiError('This invoice is already requested');
        case 'ERR_BAD_PARAM':     return new errors.ApiError('Bad parameter');
        case 'ERR_EMPTY_PARAM':   return new errors.ApiError('Needle parameter is not present');
        case 'ERR_SERVICE':       return new errors.ApiError('Service error');
        case 'ERR_ACC_BLOCKED':   return new errors.ApiError('Account is blocked!');
