...
errors.InvalidUserType =        Error.subclass('InvalidUserType');
errors.NotFound =               Error.subclass('NotFound');
errors.AlreadyExists =          Error.subclass('AlreadyExists');
errors.InvoiceExpired =         Error.subclass('InvoiceExpired');
errors.InvoiceRequested =       Error.subclass('InvoiceRequested');
errors.BadParam =               Error.subclass('BadParam');
errors.EmptyParam =             Error.subclass('EmptyParam');
errors.ServiceError =           Error.subclass('ServiceError');
errors.AccountBlocked =         Error.subclass('AccountBlocked');
...
errors.getProtocolError = function(code, msg) {
    ...
    switch(code) {
        ...
        case 'ERR_BAD_TYPE':      return new errors.InvalidUserType('Invalid user type for this operation');
        case 'ERR_NOT_FOUND':     return new errors.NotFound('Record is not found');
        case 'ERR_ALREADY_EXISTS':return new errors.AlreadyExists('Record already exists');
        case 'ERR_INV_EXPIRED':   return new errors.InvoiceExpired('This invoice is expired');
        case 'ERR_INV_REQUESTED': return new errors.InvoiceRequested('This invoice is already requested');
        case 'ERR_BAD_PARAM':     return new errors.BadParam('Bad parameter');
        case 'ERR_EMPTY_PARAM':   return new errors.EmptyParam('Needle parameter is not present');
        case 'ERR_SERVICE':       return new errors.ServiceError('Service error');
        case 'ERR_ACC_BLOCKED':   return new errors.AccountBlocked('Account is blocked!');
